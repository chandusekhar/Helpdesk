            ...
            while (!Done)
            {
                ...
                foreach (var item in DefaultRoleClaimCatalog.Catalog)
                {
                    if (item.Version == dbVersion.Value)
                    {
                        ...
                        if (role == null)
                        {
                            role = await RightsManagement.CreateRole(context, item.RoleName, item.RoleDescription, item.IsPrivileged, item.IsSuperAdmin);
                ...
                foreach (var item in SiteNavTemplateCatalog.Catalog)
                {
                    if (item.Version == dbVersion.Value)
                    {
                        ...
                        if (temp != null)
                        {
                            ...
                            temp.TicketTypeLink = item.SiteNavTemplate.TicketTypeLink;
