...
namespace Helpdesk.Infrastructure
{
    public class DI_BaseController : Controller
    {
        ...
        public DI_BaseController(ApplicationDbContext dbContext,
        ...
        protected async Task<bool> LoadControllerSettings(ViewDataDictionary viewData)
        {
            ...
            if (_signInManager.IsSignedIn(User))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        // build navbar - no need to do this in a controller.
            ...
            // no need to do this in a controller
